...
MariaDB [cc104_2a]> SELECT FNAME, LNAME FROM tblstudent WHERE GRADE < 2.00;
+-------------+----------+
| FNAME       | LNAME    |
+-------------+----------+
| Apple Grace | Galang   |
...
MariaDB [cc104_2a]> SELECT FNAME, LNAME FROM tblstudent WHERE SUBJCODE = 'MATH34';
+--------+--------+
| FNAME  | LNAME  |
+--------+--------+
| Julian | Torres |
...
MariaDB [cc104_2a]> SELECT FNAME, LNAME FROM tblstudent WHERE ADDRESS = 'Cabanatuan City';
+--------+--------+
| FNAME  | LNAME  |
+--------+--------+
| Ferdie | Marcos |
...
--- Query 1
SELECT FNAME, LNAME FROM tblstudent WHERE GRADE < 2.00;

--- Query 2
SELECT * FROM tblstudent WHERE FNAME LIKE '%E';

--- Query 3
SELECT * FROM tblstudent WHERE AGE > 20 AND GRADE < 2.00;

--- Query 4
SELECT FNAME, LNAME FROM tblstudent WHERE SUBJCODE = 'MATH34';

--- Query 5
SELECT FNAME, LNAME FROM tblstudent WHERE ADDRESS = 'Cabanatuan City';
